...
Source: https://tickmark-kappa.vercel.app/close/rulebook
...
| `extracted/tokens.json` | Design tokens: 20 colors, 2 fonts, 7 headings, 0 CTAs |
...
- **Colors**: #FFFFFF (bg-light), #0D253D (accent), #F6F9FC (bg-light), #64748D (neutral), #273951 (accent), #2776CE (accent), #0A9D0A (accent), #EEF3F9 (bg-light), #8A99AD (neutral), #E3E8EE (bg-light)
