...
Source: https://tickmark-kappa.vercel.app/close
...
| `extracted/tokens.json` | Design tokens: 20 colors, 2 fonts, 7 headings, 1 CTAs |
...
- **Colors**: #FFFFFF (bg-light), #0D253D (accent), #64748D (neutral), #8A99AD (neutral), #533AFD (accent), #0F7A34 (accent), #EEF3F9 (bg-light), #E3E8EE (bg-light), #2A78D6 (accent), #1BAF7A (accent)
