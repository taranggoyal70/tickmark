...
Source: https://tickmark-kappa.vercel.app/close/reconciliation
...
| `extracted/tokens.json` | Design tokens: 20 colors, 2 fonts, 3 headings, 0 CTAs |
...
- **Colors**: #FFFFFF (bg-light), #0D253D (accent), #64748D (neutral), #F6F9FC (bg-light), #273951 (accent), #E3E8EE (bg-light), #EEF3F9 (bg-light), #4434D4 (accent), #5940FF (accent), #5239FC (accent)
