...
colors:
  ...
  text-muted: "#273951"
  text-light: "#9A9A9A"
  accent-light: "rgba(83, 58, 253, 0.08)"
  accent-medium: "rgba(83, 58, 253, 0.15)"
  border: "rgba(83, 58, 253, 0.2)"
  card-bg: "rgba(83, 58, 253, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  h1:      { fontFamily: "Inter", cqw: 4.2, weight: 600, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
...
- **Weights** — the brand font ships `{300, 400, 500, 600}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
